...
public class UpcomingBookingsDatum {
    ...
    @Expose
    private UpcomingBookingHotel hotel;
    ...
    public UpcomingBookingHotel getHotel() {
        return hotel;
    }

    public void setHotel(UpcomingBookingHotel hotel) {
        this.hotel = hotel;
    }
