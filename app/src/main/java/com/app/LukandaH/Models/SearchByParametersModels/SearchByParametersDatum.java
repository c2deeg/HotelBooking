...
public class SearchByParametersDatum {

    @SerializedName("location")
    @Expose
    private SearchByParametersLocation location;
    ...
    @Expose
    private List<SearchByParametersRating> rating = null;
    ...
    public SearchByParametersLocation getLocation() {
        return location;
    }

    public void setLocation(SearchByParametersLocation location) {
    ...
    public List<SearchByParametersRating> getRating() {
        return rating;
    }

    public void setRating(List<SearchByParametersRating> rating) {
        this.rating = rating;
    }
