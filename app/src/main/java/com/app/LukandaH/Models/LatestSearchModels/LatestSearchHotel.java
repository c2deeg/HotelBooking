...
public class LatestSearchHotel {

    @SerializedName("location")
    @Expose
    private LatestSearchLocation location;
    ...
    @Expose
    private List<LatestSearchRating> rating = null;
    ...
    public LatestSearchLocation getLocation() {
        return location;
    }

    public void setLocation(LatestSearchLocation location) {
    ...
    public List<LatestSearchRating> getRating() {
        return rating;
    }

    public void setRating(List<LatestSearchRating> rating) {
        this.rating = rating;
    }
