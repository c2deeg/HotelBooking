...
public class UpcomingBookingHotel {

        @SerializedName("location")
        @Expose
        private UpcomingBookingLocation location;
        ...
        @Expose
        private List<UpcomingBookingRating> rating = null;
        ...
        public UpcomingBookingLocation getLocation() {
            return location;
        }

        public void setLocation(UpcomingBookingLocation location) {
        ...
        public List<UpcomingBookingRating> getRating() {
            return rating;
        }

        public void setRating(List<UpcomingBookingRating> rating) {
            this.rating = rating;
        }
