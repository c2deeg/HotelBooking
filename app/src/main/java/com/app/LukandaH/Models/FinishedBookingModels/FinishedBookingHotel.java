...
public class FinishedBookingHotel {

    @SerializedName("location")
    @Expose
    private FinishedBookingLocation location;
    ...
    @Expose
    private List<FinishedBookingRating> rating = null;
    @SerializedName("overAllRating")
    @Expose
    private Integer overAllRating;

    public FinishedBookingLocation getLocation() {
        return location;
    }

    public void setLocation(FinishedBookingLocation location) {
    ...
    public List<FinishedBookingRating> getRating() {
        return rating;
    }

    public void setRating(List<FinishedBookingRating> rating) {
        this.rating = rating;
    }
